...
public class AgendaController {
    ...
    private void initialize() {
        ...
        try {
            ...
            logger.error("No se ha podido restaurar el backup");
        }
    ...
    private void setDataInfo(Persona persona) {
        logger.debug("Se ha seleccionado la persona: " + persona);
        logger.info("Se ha seleccionado la persona: " + persona);
        logger.warn("Se ha seleccionado la persona: " + persona);
        logger.error("Se ha seleccionado la persona: " + persona);
    ...
    private void borrarAvatar(Persona persona) {
        try {
            ...
            logger.error("No se ha podido borrar el avatar de la persona: " + e.getMessage());
        }
    }
    ...
    private void salvarAvatar(Persona persona) {
        try {
            ...
            logger.error("No se ha podido salvar el avatar de la persona: " + e.getMessage());
        }
    }

    @FXML
    private void onEstadisticasAction() throws IOException {
