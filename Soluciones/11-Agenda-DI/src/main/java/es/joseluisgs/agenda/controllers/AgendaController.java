...
import es.joseluisgs.agenda.DI.DaggerRepositoryFactory;
...
public class AgendaController {
    private Logger logger = LogManager.getLogger(AgendaController.class);
    // Mi repositorio de personas

    private PersonasRepository personasRepository = DaggerRepositoryFactory.create().build();
    // Otra alternativa es inyectar el repositorio en el constructor o initializer
    // @Inject
